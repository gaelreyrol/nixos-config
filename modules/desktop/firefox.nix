...
in {
  options.desktop.firefox = {
    ...
    gnome = lib.mkOption {
      type = lib.types.bool;
      default = true;
      description = "Configure Firefox for GNOME";
    };
    sync-username = lib.mkOption {
      type = lib.types.string;
      default = "me@gaelreyrol.com";
      description = "Sync Firefox with account";
    };
  };
  ...
  config = lib.mkIf cfg.enable {
    programs.firefox = {
      enable = true;
      package = lib.mkIf cfg.gnome pkgs.firefox.override {
        cfg = {
          enableGnomeExtensions = true;
        };
      };
      # More addons to come: https://gitlab.com/rycee/nur-expressions/-/issues/89
      ...
      profiles.default = {
        ...
        settings = {
          "services.sync.username" = cfg.sync-username;
